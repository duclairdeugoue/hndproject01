...
<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="./SA_index.php">
        ...
        <div class="sidebar-brand-text mx-3"> SAdmin <sup>DD</sup></div>
    </a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="././SA_index.php">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="display_admin_list.php" >Admin List</a>
