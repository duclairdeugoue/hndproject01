        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="card my-2 mx-2 ">
                <div class="card-title my-2 ml-5">
                    <button type="button" class="btn btn-info" data-backdrop="static" data-toggle="modal" data-target="#AddLecturer">Add New Lecturer </button>
                    <a href="SA_index.php" class="btn btn-secondary ">Home</a>

                    <div class="card-body">
                        <p id="delete-message"></p>
                        <div class="" id="table_admin_display">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    global $con;
                                    $i= 1;
                                    $query = "select distinct persons.id_person,persons.name,persons.surname,persons.sex,persons.date_of_birth, lecturers.matricule from persons,lecturers where persons.id_person=lecturers.id_person";
