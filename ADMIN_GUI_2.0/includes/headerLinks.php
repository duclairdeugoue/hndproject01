<?php include("./includes/dailyAttendanceCRUD.php");?>
<?php include("./includes/weeklyAttendanceCRUD.php");?>
<?php include("./includes/monthlyAttendanceCRUD.php");?>
<?php include("./includes/yearlyAttendanceCRUD.php");?>
