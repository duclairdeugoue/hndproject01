...
<div class="landingContent">
    ...
    <div class="landingMessage">
        <div class="">
            <span class="border-none"><img src="./img/undraw_profile_1.svg" alt="" class="rounded-circle landingLogo"></span>
        </div>
        <div class="">
        ...
        <div class="">
            <a class="btn btn-outline-success btn-responsive mt-3 px-2 py-3" href="./D_attendance_form.php">Start Attendance Now</a>
        </div>
    </div>
